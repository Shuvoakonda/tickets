                    ...
                    <div class="widget-1 widget-check">
                        ...
                        <div class="widget-1-body">
                            ...
                            <div class="check-area">
                                ...
                                <div class="form-group">
                                    <input type="checkbox" name="lang" id="cat8"><label for="cat8">music
                                        shows</label>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" name="lang" id="cat9"><label for="cat9">comedy
                                        shows</label>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" name="lang" id="cat10"><label for="cat10">Award
                                        shows</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-10 justify-content-center">
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="{{ route('event_details') }}">Digital Economy Conference 2020</a>
                                        </h5>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="{{ route('event_details') }}">web design conference 2020</a>
                                        </h5>
                                        <div class="movie-rating-percent">
                                            <span>327 Montague Street</span>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="{{ route('event_details') }}">digital thinkers meetup</a>
                                        </h5>
                                        <div class="movie-rating-percent">
                                            <span>327 Montague Street</span>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="{{ route('event_details') }}">world Digital Conference</a>
                                        </h5>
                                        <div class="movie-rating-percent">
                                            <span>327 Montague Street</span>
                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="event-grid">
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="{{ route('event_details') }}">AIGA design conference</a>
                                        </h5>
                                        <div class="movie-rating-percent">
                                            <span>327 Montague Street</span>
                                        </div>
